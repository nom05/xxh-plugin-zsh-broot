...
4. Push your commits and rename your repo to `xxh-plugin-zsh-broot`
5. Install the plugin to your xxh home:
```
xxh +I xxh-plugin-zsh-broot+git+https://github.com/yourname/xxh-plugin-zsh-broot
```
